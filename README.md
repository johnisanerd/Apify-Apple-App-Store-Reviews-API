...
| `max_reviews` | `int` | no | `100` | Maximum reviews per app. Set `0` for unlimited (internally capped for safety). |
...
Download the desktop app: https://claude.ai/download?CLAUDE_REFERRAL
...
Learn more about Claude Code: https://claude.ai/code?CLAUDE_REFERRAL
...
Open Claude on the web: https://claude.ai?CLAUDE_REFERRAL
